...
const perks = [
  {
    name: 'Experts in domain',
    description:
      'Our team of domain experts delivers tailored software solutions to meet your specific industry needs.',
    icon: GlobeAltIcon,
  },
  {
    name: '10 Years of experience',
    description:
      'With a decade of experience, we navigate complexity and deliver exceptional results for your projects.',
    icon: ClockIcon,
  },
  {
    name: 'Teamwork with clients',
    description:
      'We foster strong partnerships through close collaboration, open communication, and transparency.',
    icon: FolderOpenIcon,
  },
  {
    name: 'Focuse on results',
    description:
      'We focus on delivering measurable outcomes that solve your business problems and drive success.',
...
export function WorkWithUs() {
  return (
    <section className="w-full bg-white mt-20  sm:mt-20 md:pt-[0vw]" id="workwithus" >
      ...
      <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
        <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a
              href="#"
              className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
            >
              Get started
            </a>
...
export function Hero() {
  return (
    <div className="relative isolate w-full h-screen px-6 pt-14 lg:pt-32 lg:px-8">
        <div
          className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80"
          aria-hidden="true"
        >
          <div
            className="relative left-[calc50%-11rem)] aspect-[855/678] w-[46.125rem] -translate-x-1/2 rotate-[50deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-3xl py-16 mb-16">
          ...
          <span className="relative">Leading</span>
            ...
            Wintech provides leading software development service, as well as modification and audit of various software solutions.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#development"
              ...
              <a href="/contact" className="font-semibold text-sm text-black">
...
const features = [
  {
    name: 'Custom Web, Mobile and Desktop Apps Development',
    description:
      'We develop innovative, custom software solutions tailored to your unique business requirements.',
  },
  {
    name: 'IoT Solutions Development',
    description:
      'Our IoT solutions leverage cutting-edge technologies to connect devices and unlock new opportunities.',
  },
  {
    name: 'Software QA & Testing',
    description:
      'We ensure the highest quality software through rigorous QA processes and comprehensive testing.We are relentless in our pursuit of excellence, working hard to achieve our objectives.',
  },
  {
    name: 'IT-Consulting',
    description:
      'We continuously provide and seek constructive feedOur expert IT consultants provide strategic guidance to optimize your technology investments.back, learning from our experiences and each other.',
  },
  {
    name: 'UI/UX Design Development',
    description:
      'We create intuitive and engaging user experiences through our UI/UX design services.',
  },
  {
    name: 'Outsourced software development',
    description:
      'Our outsourced development services offer flexibility and scalability to meet your project needs.',
  },
]

export function Values() {
  return (
  <section className="w-full bg-customDarkBg2 mt-10 mb-10 sm:mt-20 sm:mb-20 md:pt-[0vw]" id="development" >
    
      <div className="mt-0 mb-20">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 sm:py-20">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          <div>
            <p className="font-display text-3xl tracking-tight text-slate-900 md:text-left text-center  sm:text-4xl">Development Service</p>
            <p className="mt-4 text-lg tracking-tight md:text-left text-center  text-slate-700">
            Our comprehensive development services cover the full spectrum of software solutions, from ideation to deployment, ensuring your project's success at every stage.
            </p>
